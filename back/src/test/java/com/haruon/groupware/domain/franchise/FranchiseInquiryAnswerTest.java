...
class FranchiseInquiryAnswerTest {
    ...
    void createInquiryDraft_success() {
        ...
        emp.changeInfoByAdmin(null, null, null, null, null, null, SystemRoleCode.FRANCHISE, null, null);
    ...
    void udpate_assigned_emp_when_update_answer() {
        ...
        emp1.changeInfoByAdmin(null, null, null, null, null, null, SystemRoleCode.FRANCHISE, null, null);

        inquiry.createAnswerDraft("test", emp1);

        Emp emp2 = EmpFixture.getApprovedEmp("202601001", "login1");
        emp2.changeInfoByAdmin(null, null, null, null, null, null, SystemRoleCode.FRANCHISE, null, null);
