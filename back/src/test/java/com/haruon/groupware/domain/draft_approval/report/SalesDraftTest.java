...
class SalesDraftTest {
    ...
    void createDraft() {
        ...
        assertThat(SalesDraft).extracting(
                com.haruon.groupware.domain.draft_approval.report.SalesDraft::getReportMonth,
                com.haruon.groupware.domain.draft_approval.report.SalesDraft::getSalesAmount
        ).containsExactly(
