package com.haruon.groupware.adapter.docs.webAPI.documentBox;
...
public class DocumentBoxApiDocsTest extends RestDocsSupport {

    private final DocumentBoxRetriever documentBoxRetriever = mock(DocumentBoxRetriever.class);
    private final String REQUEST_MAPPING_URL = "/api/document-box";

    @Override
    protected Object initController() {
        return new MyDocumentBoxApi(documentBoxRetriever);
    }
