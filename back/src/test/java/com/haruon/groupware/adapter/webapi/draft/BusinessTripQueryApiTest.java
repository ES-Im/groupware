...
public class BusinessTripQueryApiTest extends IntegrationTestSupport {
    ...
    void deptBusinessTripRequestHistories_success() throws Exception {
        ...
        mockMvc.perform(
                        get("/api/business-trips/departments/{deptId}/request-history", dept.getId())
    ...
    void myBusinessTripRequestHistories_success() throws Exception {
        ...
        mockMvc.perform(
                        get("/api/business-trips/employees/me/request-history")
