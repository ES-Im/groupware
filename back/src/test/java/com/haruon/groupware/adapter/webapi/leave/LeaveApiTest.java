package com.haruon.groupware.adapter.webapi.leave;
...
public class LeaveApiTest extends IntegrationTestSupport {
    ...
    void deptLeaveRequestHistories_success() throws Exception {
        ...
        mockMvc.perform(
                        get("/api/leave/departments/{deptId}/request-history", dept.getId())
    ...
    void myLeaveRequestHistories_success() throws Exception {
        ...
        mockMvc.perform(
                        get("/api/leave/employees/me/request-history")
