...
public class DocumentBoxQueryApiTest extends IntegrationTestSupport {
    ...
    void mySubmittedDrafts_success() throws Exception {
        ...
        mockMvc.perform(
                        get("/api/document-boxes/me/submitted-drafts")
    ...
    void myUnsubmittedDrafts_success() throws Exception {
        ...
        mockMvc.perform(
                        get("/api/document-boxes/me/unsubmitted-drafts")
                                .header("Authorization", BEARER + accessToken)
                                .param("keyword", "임시")
                                .param("page", "0")
                                .param("size", "10")
    ...
    void pendingMyApprovalDrafts_success() throws Exception {
        ...
        mockMvc.perform(
                        get("/api/document-boxes/me/pending-approval-drafts")
                                .header("Authorization", BEARER + accessToken)
                                .param("keyword", "결재")
                                .param("page", "0")
                                .param("size", "10")
