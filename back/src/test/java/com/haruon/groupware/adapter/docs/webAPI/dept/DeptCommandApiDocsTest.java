...
import com.haruon.groupware.adapter.webapi.dept.DeptCommandApi;
...
public class DeptCommandApiDocsTest extends RestDocsSupport {
    ...
    protected Object initController() {
        return new DeptCommandApi(deptManagement);
    }
