...
import com.haruon.groupware.adapter.webapi.draft.LeaveQueryApi;
...
public class LeaveQueryApiDocsTest extends RestDocsSupport {

    private final LeaveDraftRetriever leaveDraftRetriever = mock(LeaveDraftRetriever.class);
    private final String REQUEST_MAPPING_URL = "/api/leaves";

    @Override
    protected Object initController() {
        return new LeaveQueryApi(leaveDraftRetriever);
    }
