...
import com.haruon.groupware.adapter.webapi.emp.empLeave.EmpLeaveApi;
...
public class EmpLeaveApiDocsTest extends RestDocsSupport {

    private final LeaveRetriever leaveRetriever = mock(LeaveRetriever.class);

    @Override
    protected Object initController() {
        return new EmpLeaveApi(leaveRetriever);
    }
