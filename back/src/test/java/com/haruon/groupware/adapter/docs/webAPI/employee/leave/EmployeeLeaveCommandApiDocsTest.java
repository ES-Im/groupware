...
import com.haruon.groupware.adapter.webapi.employee.leave.EmployeeLeaveCommandApi;
...
public class EmployeeLeaveCommandApiDocsTest extends RestDocsSupport {

    private final LeaveGrantManagement leaveGrantManagement = mock(LeaveGrantManagement.class);

    @Override
    protected Object initController() {
        return new EmployeeLeaveCommandApi(leaveGrantManagement);
    }
