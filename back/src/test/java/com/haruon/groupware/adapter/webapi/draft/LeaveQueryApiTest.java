...
public class LeaveQueryApiTest extends IntegrationTestSupport {
    ...
    void deptLeaveRequestHistories_success() throws Exception {
        ...
        mockMvc.perform(
                        get("/api/leaves/departments/{deptId}/request-history", dept.getId())
    ...
    void myLeaveRequestHistories_success() throws Exception {
        ...
        mockMvc.perform(
                        get("/api/leaves/employees/me/request-history")
