...
import com.haruon.groupware.adapter.webapi.company.CompanyCommandApi;
...
public class CompanyCommandApiDocsTest extends RestDocsSupport {

    private final CompanyManagement companyManagement = mock(CompanyManagement.class);
    private final static String REQUEST_MAPPING = "/api/companies";

    @Override
    protected Object initController() {
        return new CompanyCommandApi(companyManagement);
    }
