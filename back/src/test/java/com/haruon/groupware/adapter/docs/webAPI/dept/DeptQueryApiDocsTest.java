...
import com.haruon.groupware.adapter.webapi.dept.DeptQueryApi;
...
public class DeptQueryApiDocsTest extends RestDocsSupport {
    ...
    DeptQueryApiSupport support = new DeptQueryApiSupport();

    @Override
    protected Object initController() {
        return new DeptQueryApi(deptRetriever);
    }
