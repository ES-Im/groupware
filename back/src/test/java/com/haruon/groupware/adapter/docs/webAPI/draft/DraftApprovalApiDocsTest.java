...
import com.haruon.groupware.adapter.webapi.draft.DraftApprovalApi;
...
public class DraftApprovalApiDocsTest extends RestDocsSupport {
    ...
    protected Object initController() {
        return new DraftApprovalApi(draftManagementResolver);
    }
