...
import com.haruon.groupware.adapter.webapi.draft.DraftRetrievalApi;
...
public class DraftRetrievalApiDocsTest extends RestDocsSupport {
    ...
    protected Object initController() {
        return new DraftRetrievalApi(documentBoxRetriever);
    }
