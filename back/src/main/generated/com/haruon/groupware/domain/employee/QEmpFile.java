...
public class QEmpFile extends EntityPathBase<EmpFile> {
    ...
    private static final long serialVersionUID = 35409142L;
    ...
    public final EnumPath<com.haruon.groupware.domain.employee.enums.FileType> fileType = createEnum("fileType", com.haruon.groupware.domain.employee.enums.FileType.class);
