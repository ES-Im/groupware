...
public class QEmpBelongings extends EntityPathBase<EmpBelongings> {
    ...
    private static final long serialVersionUID = -599197046L;
    ...
    public final EnumPath<com.haruon.groupware.domain.employee.enums.PositionCode> position = createEnum("position", com.haruon.groupware.domain.employee.enums.PositionCode.class);
