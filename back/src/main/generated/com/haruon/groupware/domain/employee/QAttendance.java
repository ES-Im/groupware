...
public class QAttendance extends EntityPathBase<Attendance> {
    ...
    private static final long serialVersionUID = -409566441L;
    ...
    public final EnumPath<com.haruon.groupware.domain.employee.enums.AttendanceStatus> attendanceStatus = createEnum("attendanceStatus", com.haruon.groupware.domain.employee.enums.AttendanceStatus.class);
