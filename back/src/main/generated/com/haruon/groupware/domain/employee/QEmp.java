...
public class QEmp extends EntityPathBase<Emp> {
    ...
    private static final long serialVersionUID = -917069734L;
    ...
    public final EnumPath<com.haruon.groupware.domain.employee.enums.EmpStatus> status = createEnum("status", com.haruon.groupware.domain.employee.enums.EmpStatus.class);

    public final SetPath<com.haruon.groupware.domain.employee.enums.SystemRoleCode, EnumPath<com.haruon.groupware.domain.employee.enums.SystemRoleCode>> systemRoles = this.<com.haruon.groupware.domain.employee.enums.SystemRoleCode, EnumPath<com.haruon.groupware.domain.employee.enums.SystemRoleCode>>createSet("systemRoles", com.haruon.groupware.domain.employee.enums.SystemRoleCode.class, EnumPath.class, PathInits.DIRECT2);
