...
@StepScope
@Component
public class EducationApplicationRetryItemReader extends FranchiseRetrySyncItemReader {

    public EducationApplicationRetryItemReader(FranchiseSyncRequestRepository repository) {
        super(repository);
    }

    @Override
    protected SyncType syncType() {
        return SyncType.EDUCATION_APPLICATION;
    }
}
