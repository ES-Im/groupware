...
@StepScope
@Component
public class InquiryRetryItemReader extends FranchiseRetrySyncItemReader {

    public InquiryRetryItemReader(FranchiseSyncRequestRepository repository) {
        super(repository);
    }

    @Override
    protected SyncType syncType() {
        return SyncType.INQUIRY;
    }
}
