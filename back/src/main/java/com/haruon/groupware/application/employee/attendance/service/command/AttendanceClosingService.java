...
import static com.haruon.groupware.domain.employee.Attendance.*;
import static com.haruon.groupware.domain.employee.enums.AttendanceStatus.*;
...
public class AttendanceClosingService implements AttendanceClosing {
    ...
    @Override
    public int closeAttendance(AttendanceCloseRequest param) {
