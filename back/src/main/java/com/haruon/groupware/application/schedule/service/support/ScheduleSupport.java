package com.haruon.groupware.application.schedule.service.support;
...
public class ScheduleSupport {
    ...
    public static List<Schedule> getSchedulesById(ScheduleRepository scheduleRepository, Long scheduleId, boolean isForBulkEdit) {
    ...
    public static List<Schedule> getSchedulesBySourceKey(ScheduleRepository scheduleRepository, String sourceKey) {
        return getSameEventSchedules(scheduleRepository, sourceKey);
    }

    public static Schedule getScheduleById(ScheduleRepository scheduleRepository, Long scheduleId) {
        return scheduleRepository
                .findById(scheduleId)
                .orElseThrow(ScheduleNotFoundException::new);
    }

    public static List<Schedule> getSameEventSchedules(ScheduleRepository scheduleRepository, String sourceKey) {
    ...
    public static List<Schedule> registerSchedule(
