...
/**
 * downloadEducationFile(EDUCATION_FILE_DOWNLOAD) 단위 테스트.
 * board downloadBoardFile/meeting downloadMeetingRoomFile과 동형 — blob 조회 후 임시 <a>로 저장을
 * 트리거하고 objectURL을 즉시 revoke한다.
 */
