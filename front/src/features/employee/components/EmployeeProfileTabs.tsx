 ...
 * 기본정보/부서이력 2탭 + viewerIsSelf면 파일관리 탭(EmpFileManagementPanel, 업로드·활성화·삭제)을 더한다.
 *
 ...
 */
export function EmployeeProfileTabs({ data, empId, actions, viewerIsSelf = true }: EmployeeProfileTabsProps) {
  ...
  return (
    <Card className="h-fit">
      <CardHeader className="border-b">
        ...
        <CardDescription>기본정보, 부서 이력{viewerIsSelf && ', 파일 관리'}를 탭으로 나누어 관리합니다.</CardDescription>
      ...
      <CardContent>
        <Tabs defaultValue="basic">
          <TabsList>
            ...
            <TabsTrigger value="dept">부서이력</TabsTrigger>
          ...
          {/* 부서이력 탭: 부서별 카드(대표/겸직 배지 · 부서코드·직위 · 발령기간). */}
