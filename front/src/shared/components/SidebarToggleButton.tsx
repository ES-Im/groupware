...
export function SidebarToggleButton({
  ...
  return (
    <Button
      ...
      className="border-primary-foreground/25 bg-transparent text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary-foreground dark:border-card-foreground/25 dark:text-card-foreground dark:hover:bg-card-foreground/10 dark:hover:text-card-foreground"
    >
      {showCloseIcon ? (
